...
public class GameBoardMedium extends JPanel implements ActionListener {
	...
	// need the dimensions for the height n width of the ghost1 image
		public int ghost4width = 20;
		public int ghost4height = 20;
	...
	// These two arrays store the x, y coordinates of all possible positions on
	// the board for ghost bot 4
	public int ghostx4[] = new int[Maximum_pixels_on_screen];
	public int ghosty4[] = new int[Maximum_pixels_on_screen];

	// These two arrays store the x, y coordinates of all possible positions on
	// the board for cherry item
	public int itemx1[] = new int[Maximum_pixels_on_screen];
	public int itemy1[] = new int[Maximum_pixels_on_screen];
	...
	// for the game
	public GameBoardMedium(GameFrame frame, // game window created in the GameStart
										// class
...
//				// -----------------------------------------------------------------------------
	...
	private void loadGhost4(String Ghost4Image) {

		// added second pacman player
		try {
			ghost4 = ImageIO.read(getClass().getResourceAsStream(
					Ghost4Image));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void loadItem1(String Item1Image) {

		// added second pacman player
		try {
			item1 = ImageIO.read(getClass().getResourceAsStream(
					Item1Image));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void Ghostmove() {
		...
		// 4th ghost bot movement

		if (ghostmoveup) {
			ghosty4[0] = ghosty4[0] - 20; // is the size of each ghost - so will move a
								// whole tile
		}

		// This line moves pacman down.
		if (ghostmovedown) {
			ghosty4[0] = ghosty4[0] + 20;
		}

		// This line moves pacman to the right.
		if (ghostmoveright) {
			ghostx4[0] = ghostx4[0] + 20;
		}
	...
	public void checkGhostCollision() {
		...
		// collision for player 1 and ghost 1 when item has not been used
				if ((playerx1[0] == ghostx1[0]) &&  (playery1[0] == ghosty1[0]) &&
						itemx1[0] != - 40 && itemy1[0] != - 40) {
				...
				// collision for player 1 and ghost 1 when the item has been used - ghost 1 gets removed out of the screen
					else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
							(playerx1[0] == ghostx1[0]) &&  (playery1[0] == ghosty1[0])) {
				...
				// collision for player 2 and ghost 1 when item has not been used
						...
						// collision for player 2 and ghost 1 when the item has been used - ghost 1 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx2[0] == ghostx1[0]) &&  (playery2[0] == ghosty1[0])) {
			...
			// --------------------------------------------------------------------------------------------------------------------------
						...
						// collision for player 1 and ghost 2 when item has not been used
						...
						// collision for player 1 and ghost 2 when the item has been used - ghost 1 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx1[0] == ghostx2[0]) &&  (playery1[0] == ghosty2[0])) {
						...
						// collision for player 2 and ghost 2 when item has not been used
						...
						// collision for player 2 and ghost 2 when the item has been used - ghost 2 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx2[0] == ghostx2[0]) &&  (playery2[0] == ghosty2[0])) {
				...
				// ----------------------------------------------------------------------------------------------------------------
						...
						// collision for player 1 and ghost 3 when item has not been used
						...
						// collision for player 1 and ghost 3 when the item has been used - ghost 1 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx1[0] == ghostx3[0]) &&  (playery1[0] == ghosty3[0])) {
						...
						// collision for player 2 and ghost 3 when item has not been used
						...
						// collision for player 2 and ghost 3 when the item has been used - ghost 2 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx2[0] == ghostx3[0]) &&  (playery2[0] == ghosty3[0])) {
		...
		// ----------------------------------------------------------------------------------------------------------------
						...
						// collision for player 1 and ghost 4 when item has not been used
						if ((playerx1[0] == ghostx4[0]) &&  (playery1[0] == ghosty4[0]) &&
								itemx1[0] != - 40 && itemy1[0] != - 40) {
						...
						// collision for player 1 and ghost 4 when the item has been used - ghost 1 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx1[0] == ghostx4[0]) &&  (playery1[0] == ghosty4[0])) {
						...
						// collision for player 2 and ghost 4 when item has not been used
						if ((playerx2[0] == ghostx4[0]) &&  (playery2[0] == ghosty4[0]) &&
								itemx1[0] != - 40 && itemy1[0] != - 40) {
						...
						// collision for player 2 and ghost 4 when the item has been used - ghost 2 gets removed out of the screen
							else if (itemx1[0]== - 40 && itemy1[0] == - 40 &&
									(playerx2[0] == ghostx4[0]) &&  (playery2[0] == ghosty4[0])) {
...
public void checkItemCollision() {
		...
		if ((playerx1[0] == itemx1[0]) &&  (playery1[0] == itemy1[0])) {
			// removes the item off the screen when player goes over it
			itemx1[0]= - 40;
			itemy1[0]= - 40;

	}

		if ((playerx2[0] == itemx1[0]) &&  (playery2[0] == itemy1[0])) {
			// removes the item off the screen when player goes over it
			itemx1[0]= - 40;
			itemy1[0]= - 40;
		...
		if (playing) {
			...
			for (int i = 0; i < pac1; i++) {
				if (i < 1) {
					...
					graphics.drawImage(ghost4, ghostx4[0], ghosty4[0], null);

					// print item
					graphics.drawImage(item1, itemx1[0], itemy1[0], null);
