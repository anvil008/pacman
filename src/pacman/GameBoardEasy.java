...
public class GameBoardEasy extends JPanel implements ActionListener {
	...
	// timer variable used for wall collisions
	...
	// for the game
	public GameBoardEasy(GameFrame frame, // game window created in the GameStart
										// class
...
//				// -----------------------------------------------------------------------------
	...
	public void gameTimer(Graphics graphics) {
		...
		graphics.drawString(Timer, 400, 585);
	...
	// there is a cherry item for this particular level - once a pacman eats a cherry, it can eat the ghosts!
	// competitive player can come in here where players rush to get the cherry item to beat the other
...
&& ghostx1[0] != 420 && ghostx1[0] != 440 && ghostx1[0] != 460 && ghostx1[0] != 500 && ghostx1[0] != 520)
	...
	public void paintComponent(Graphics graphics) {
		...
		gameOver (graphics);
		// added gameTimer so that when timer reaches zero, game ends
		gameTimer (graphics);
